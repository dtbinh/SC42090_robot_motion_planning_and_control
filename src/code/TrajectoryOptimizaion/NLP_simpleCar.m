...
model.xinit = -2.5
model.xinitidx = 0 % use this to specify on which variables initial conditions are imposed

% Final condition on vehicle velocity and heading angle
model.xfinal = 0
model.xfinalidx = 0 % use this to specify on which variables final conditions are imposed
