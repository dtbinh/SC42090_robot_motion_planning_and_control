...
params(2)  = newParam('eqD',1:N,'eq.D','sparse',[B, -eye(nx)]);
params(3)  = newParam('eqC',1:N-1,'eq.C','sparse',[zeros(nx,nu), A]);
...
for k = 1:kmax
    ...
    problem.eqD = [1.0, 0.5, -1.0, 0.0, 0.0, -1.0]';
    problem.eqC = [1.1, 0.0, 1.0, 1.0]';
