...
#  define CASADI_INTEGRATORS_DEPRECATED_EXPORT CASADI_INTEGRATORS_EXPORT __attribute__ ((__deprecated__))
#  define CASADI_INTEGRATORS_DEPRECATED_NO_EXPORT CASADI_INTEGRATORS_NO_EXPORT __attribute__ ((__deprecated__))
#endif
