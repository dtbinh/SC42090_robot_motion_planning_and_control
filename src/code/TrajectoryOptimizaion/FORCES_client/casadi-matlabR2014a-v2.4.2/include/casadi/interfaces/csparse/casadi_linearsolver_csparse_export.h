...
#  define CASADI_LINEARSOLVER_CSPARSE_DEPRECATED_EXPORT CASADI_LINEARSOLVER_CSPARSE_EXPORT __attribute__ ((__deprecated__))
#  define CASADI_LINEARSOLVER_CSPARSE_DEPRECATED_NO_EXPORT CASADI_LINEARSOLVER_CSPARSE_NO_EXPORT __attribute__ ((__deprecated__))
#endif
